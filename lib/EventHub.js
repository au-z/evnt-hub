...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/EventHub.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, scripts, repository, keywords, author, license, bugs, homepage, publishConfig, devDependencies, jest, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"evnt-hub\",\"version\":\"2.2.1\",\"description\":\"Event subscription library with window.postMessage support.\",\"main\":\"index.js\",\"scripts\":{\"build\":\"webpack --mode=production\",\"dev\":\"webpack --mode=development --watch\",\"dev:demo\":\"concurrently \\\"npm run dev\\\" \\\"node server.js\\\"\",\"test\":\"jest\",\"test:watch\":\"jest --watch\",\"prepublishOnly\":\"concurrently \\\"npm run build\\\" \\\"webpack --mode=development\\\" \\\"npm run test\\\"\"},\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/auzmartist/event-hub.git\"},\"keywords\":[\"events\",\"pub\",\"sub\",\"postMessage\"],\"author\":\"Austin Martin\",\"license\":\"ISC\",\"bugs\":{\"url\":\"https://github.com/auzmartist/event-hub/issues\"},\"homepage\":\"https://github.com/auzmartist/event-hub#readme\",\"publishConfig\":{\"registry\":\"https://registry.npmjs.org/\"},\"devDependencies\":{\"@babel/cli\":\"^7.6.2\",\"@babel/core\":\"^7.6.2\",\"@babel/plugin-proposal-class-properties\":\"^7.5.5\",\"@babel/plugin-proposal-object-rest-spread\":\"^7.6.2\",\"@babel/preset-env\":\"^7.6.2\",\"@babel/preset-typescript\":\"^7.6.0\",\"@babel/register\":\"^7.6.2\",\"babel-eslint\":\"^10.0.3\",\"babel-jest\":\"^24.9.0\",\"babel-loader\":\"^8.0.6\",\"babel-polyfill\":\"^6.26.0\",\"concurrently\":\"^3.6.1\",\"core-js\":\"^3.3.2\",\"cross-env\":\"^4.0.0\",\"eslint\":\"^5.16.0\",\"eslint-config-auz\":\"^1.0.0\",\"eslint-loader\":\"^2.2.1\",\"express\":\"^4.17.1\",\"jest\":\"^24.9.0\",\"typescript\":\"^3.6.3\",\"vue\":\"^2.6.10\",\"webpack\":\"^4.40.2\",\"webpack-cli\":\"^3.3.9\",\"yargs\":\"^13.3.0\"},\"jest\":{\"transform\":{\"^.+\\\\.tsx?$\":\"babel-jest\",\"^.+\\\\.js$\":\"babel-jest\"},\"transformIgnorePatterns\":[\"node_modules\"]}}");
...
/* harmony import */ var _Hub__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Hub */ "./src/Hub.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var hub = Object(_Hub__WEBPACK_IMPORTED_MODULE_7__["default"])(VERBOSE);
  ...
  function subscribeOnce(type, func, correlationId) {
    ...
    var sub = hub.subscribe(type, function (type, payload, meta) {
      if (meta.correlates) {
        hub.unsubscribe(sub);
  ...
  function post(type) {
    ...
    var correlationId = arguments.length > 3 ? arguments[3] : undefined;
    // use the targetWindow as a fallback
    window = window || targetWindow;
    VERBOSE && console.log("Attempting to postMessage '".concat(type, "' to targetOrigin ").concat(targetOrigin, ". Payload: "), payload);
  ...
  function request(reqEvent, resEvent) {
    var reqBody = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var correlationId = arguments.length > 3 ? arguments[3] : undefined;
    var requesting = new Promise(function (res, rej) {
      return hub.subscribe(resEvent, function (e, payload, _meta) {
        res({
          value: payload,
          _meta: _meta
        });
  ...
  function requestOnce(reqEvent, resEvent) {
    var reqBody = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    var correlationId = arguments.length > 3 ? arguments[3] : undefined;
    var requesting = new Promise(function (res, rej) {
      return subscribeOnce(resEvent, function (e, payload, _meta) {
        res({
          value: payload,
          _meta: _meta
        });
  ...
  window.addEventListener('message', function (event) {
    ...
    VERBOSE && console.log("PostMessage event '".concat(event.data._type, "' received from ").concat(origin, ". Publishing."));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Hub; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
...
function Hub(verbose) {
  ...
  function subscribe(event) {
    ...
    var correlationId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    VERBOSE && console.log("Subscription to '".concat(event, "' added. Returning token: ").concat(token, "."));
    return token;
  }
  /**
  ...
  function publish(event, payload, correlationId) {
    VERBOSE && console.log("Event '".concat(event, "' published. Payload: "), payload);
    if (!eventMap[event]) return false;
    setTimeout(function () {
      var subscribers = eventMap[event];
  ...
  function unsubscribe(token) {
    var found = false;
    Object.values(eventMap).forEach(function (subscriptions) {
      var idx = subscriptions.findIndex(function (s) {
