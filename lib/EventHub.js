...
module.exports = {"name":"evnt-hub","version":"1.4.1","description":"Event subscription library with window.postMessage support.","main":"index.js","scripts":{"build":"webpack --env build","dev":"webpack --progress --colors --watch --env dev","dev:demo":"concurrently \"npm run dev\" \"node server.js\"","test":"jest","test:watch":"jest --watch","prepublish":"concurrently \"webpack --env build\" \"webpack --env dev\" \"npm run test\""},"repository":{"type":"git","url":"git+https://github.com/auzmartist/event-hub.git"},"keywords":["events","pub","sub","postMessage"],"author":"Austin Martin","license":"ISC","bugs":{"url":"https://github.com/auzmartist/event-hub/issues"},"homepage":"https://github.com/auzmartist/event-hub#readme","publishConfig":{"registry":"https://registry.npmjs.org/"},"devDependencies":{"babel":"^6.23.0","babel-core":"^6.24.1","babel-eslint":"^7.2.2","babel-jest":"^22.4.3","babel-loader":"^6.4.1","babel-plugin-add-module-exports":"^0.2.1","babel-preset-es2015":"^6.24.1","chai":"^3.5.0","concurrently":"^3.4.0","cross-env":"^4.0.0","eslint":"^3.19.0","eslint-config-auz":"^1.0.0","eslint-loader":"^1.7.1","express":"^4.15.2","jest":"^22.4.3","jsdom":"^9.12.0","jsdom-global":"^2.1.1","mocha":"^3.2.0","sinon":"^2.1.0","webpack":"^2.4.1","yargs":"^7.1.0"},"jest":{"testURL":"http://localhost"}}
